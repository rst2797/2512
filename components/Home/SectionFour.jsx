  ...
  return (
    <>
      <div className="relative lg:grid grid-cols-3 z-20 min-h-screen lg:min-h-[110vh] bg-cover bg-center bg-no-repeat bg-[url('https://s3.eu-north-1.amazonaws.com/web.pacchisbarah/images/home/Mask+group+2.png')]">
        ...
        <div className="absolute bottom-0 right-0 lg:w-[38%] flex flex-col items-end justify-center h-auto lg:h-[35%] px-4 lg:px-[4.5rem] py-4 lg:pt-32 container bg-[#ffffff6c]">
          ...
          <span className="flex justify-center my-[1.5rem] w-full">
            <Link href="/kanso">
