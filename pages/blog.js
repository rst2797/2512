...
const fetchBlogs = async () => {
  try {
    const blogs = await axios.get(`https://www.2512.in/api/get-all-blogs`);
    // const blogs = await axios.get(`https://www.2512.in/api/get-all-blogs`);
            ...
            <div className="flex flex-col justify-center text-white">
              ...
              <div className="lg:hidden">
                <p className="text-lg text-center">
                  As we step into 2024, the fashion industry continues to
                  undergo a profound transformation, with sustainability taking
                  center stage. This shift reflects a collective consciousness
