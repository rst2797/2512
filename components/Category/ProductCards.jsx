      ...
      {products?.map((ele, index) => {
        ...
        return (
          <Link href={`/collection/${ele._id}`} key={ele.id}>
            <a className="w-fit bg-white rounded-xl hover:drop-shadow-lg max-w-[22rem] overflow-hidden">
              <Image
                src={ele.images[0]}
                alt={ele.breadcrumb}
                width={400}
              ...
              />
              <div className="px-3 max-w-[95%] overflow-hidden">
                <h2 className="font-sansita-regular !text-[.94rem] !leading-[1.5rem] pt-[.25rem]">
                  {nameArray[0]}
                  <br />
                  {nameArray[1]}
                </h2>
