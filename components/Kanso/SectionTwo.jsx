...
const SectionTwo = () => {
  return (
    <div className="bg-[url('https://s3.eu-north-1.amazonaws.com/web.pacchisbarah/images/kanso/Mask+group.png')] lg:bg-[#F4E9DF] lg:flex justify-between items-center w-full px-4 lg:px-20 py-24">
      ...
      <div className="lg:w-[60%] lg:hidden flex flex-col items-center text-white">
        ...
        <Link href="/kanso">
          <a>
            <button className="bg-[#F4E9DF] text-[#2F2E2D] font-semibold text-xl py-3 px-4 rounded-lg flex items-center">Read More <IoArrowForward className="ml-2"/> </button>
          </a>
        </Link>
      </div>
    </div>
