...
const SectionOne = ({ children }) => {
  ...
  return (
    <div className="relative overflow-hidden lg:px-20 lg:bg-[url('https://s3.eu-north-1.amazonaws.com/web.pacchisbarah/images/web/our+story/1.png')] bg-cover bg-center bg-no-repeat lg:min-h-[91vh] lg:mt-[4.2rem]">
      ...
      <div className="absolute lg:relative z-50 top-0 left-0 right-0 ">
        ...
        <p className="text-center lg:text-left lg:text-white text-xs font-bold pt-3 lg:pb-4 tracking-wide">
          A story of sustainable clothing and nature loving people.
        </p>
      </div>
      <div className="hidden lg:block relative z-20 max-w-[30%] text-white">
